...
This is the shared base for Japanese learning across games. Read README.md and
ROADMAP.md before changing it. Extend this application with profiles and adapters;
...
- Run `python -m unittest -v test_profiles` for profile or journal lifecycle changes.
